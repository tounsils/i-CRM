  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center">
        <h1 data-aos="fade-up">i Customer Relationship Management System</h1>
        <h2 data-aos="fade-up" data-aos-delay="400"> Customer Relationship Management (CRM) system helps manage customer data.
          It supports sales management, delivers actionable insights, ...</h2>
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
          <div class="content">
            ...
            <p>
              ...
              CRM software is software that automates and manages the customer life cycle of an organization.
              It is usually used by the sales team, sales reps,
              and call center reps to maintain contact with customers and quickly respond to their needs </p>
          </div>
        </div>
      ...
      <div class="row gy-4" data-aos="fade-left">
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
          <div class="box">
            ...
            <ul>
              <li>Free app quote</li>
              <li>Revisions</li>
              <li class="na">Free Backup</li>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
          <div class="box">
            <h3 style="color: #65c600;">1-9 customers</h3>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
          <div class="box">
            ...
            <h3 style="color: #ff901c;">10-99 customers</h3>
        ...
        <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
          <div class="box">
          <h3 style="color: #ff901c;">100+ customers</h3>
            <div class="price"><sup>$</sup>3<span> / customer</span></div>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-12 text-center">
        ...
        <p>Got a problem that needs a solution? <br>We can help! Our clients love us because we're friendly,
          ...
          <br>We'll work with you to help you find the solutions you've been looking for!
        </p>
      </div>
      <div class="col-lg-12 text-center">
